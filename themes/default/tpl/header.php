...
<head>
  ...
  <link href="./themes/default/css/prettify.css" media="screen" rel="stylesheet">
      ...
      <?php if (fAuthorization::checkLoggedIn()): ?>
        <div class="btn-group pull-right">
          <a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
            <i class="icon-user"></i> Current User：<?php echo fAuthorization::getUserToken(); ?>
            <span class="caret"></span>
          </a>
          <ul class="dropdown-menu">
            <li><a href="<?php echo SITE_BASE; ?>/change/info">Modify Profile</a></li>
        ...
        <div class="navbar-text pull-right">
          <time>Server Time：<?php echo new fTimestamp(); ?></time>
        </div>
      <?php else: ?>
        <form action="<?php echo SITE_BASE; ?>/login.php" method="POST" class="form-inline pull-right" style="margin: 0">
          ...
          ?><a class="btn btn-success" href="<?php echo SITE_BASE; ?>/login">Register</a>
        </form>
      <?php endif; ?>
      <div class="nav-collapse">
        <ul class="nav">
          <li class="nav-home"><a href="<?php echo SITE_BASE; ?>/">Home</a></li>
          <!--<li class="nav-sets"><a href="<?php echo SITE_BASE; ?>/sets">Problem Sets</a></li>-->
          <li class="nav-problems"><a href="<?php echo SITE_BASE; ?>/problems">Problems</a></li>
          <li class="nav-reports"><a href="<?php echo SITE_BASE; ?>/contests">Contest</a></li>
          <li class="nav-homework"><a href="<?php echo SITE_BASE; ?>/homework">Homework</a></li>
          <?php if (fAuthorization::checkLoggedIn()): ?>
